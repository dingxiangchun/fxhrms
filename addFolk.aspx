<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addFolk.aspx.cs" Inherits="addFolk" %>
                            ...
                            <TBODY>
                                <TR>
                                        ...
                                        <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
                                            <TBODY>
                                                <tr>
                                                    ...
                                                    <tr>
                                                    <td class=manageHead1>
                                                        <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" Height="237px" AutoGenerateColumns="False" DataKeyNames="fid">
                                                                ...
                                                                <asp:TemplateField HeaderText="民族">
                                                                    <ItemTemplate>
                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label1" Text='<%# Eval("folkName") %>'></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </ItemTemplate>
                                    ...
                                    <TD align=right style="height: 25px">
                                        请输入民族名称:
                                        <asp:TextBox ID="tb_folk" runat="server"></asp:TextBox>&nbsp;
