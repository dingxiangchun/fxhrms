                                        ...
                                        <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
                                            <TBODY>
                                                <tr>
                                                    ...
                                                    <tr>
                                                    <td class=manageHead1>
                                                        <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" Height="237px" AutoGenerateColumns="False" DataKeyNames="id">
                                                                ...
                                                                <asp:TemplateField HeaderText="部门">
                                                                    <ItemTemplate>
                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label1" Text='<%# Eval("branchName") %>'></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </ItemTemplate>
