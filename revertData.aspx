<%@ Page Language="C#" AutoEventWireup="true" CodeFile="revertData.aspx.cs" Inherits="revertData" %>
                                ...
                                <TR>
                                    <TD>
                                        <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
                                            ...
                                            <asp:Button ID="bt_revert" CssClass="button" runat="server" Text="还原" Width="60px" OnClick="bt_revert_Click" />&nbsp;
