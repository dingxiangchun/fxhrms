                            ...
                            <TBODY>
                                <TR>
                                                ...
                                                <asp:TemplateField HeaderText="用户权限">
                                                    <ItemTemplate>
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label runat="server" ID="Label2" Text='<%# Eval("userGroup") %>'></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
                                    ...
                                    <TD align=right style="height: 25px">
                                        ...
                                        <asp:Button ID="bt_update" CssClass="button" runat="server" Text="设置权限" Width="80px" OnClick="bt_update_Click" />&nbsp;
