<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addZhiChen.aspx.cs" Inherits="addZhiChen" %>
                                        ...
                                        <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
                                            <TBODY>
                                                <tr>
                                                    ...
                                                    <tr>
                                                    <td class=manageHead1>
                                                        <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" Height="237px" AutoGenerateColumns="False" DataKeyNames="ZCID">
                                                                ...
                                                                <asp:TemplateField HeaderText="职务">
                                                                    <ItemTemplate>
                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label1" Text='<%# Eval("ZCName") %>'></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </ItemTemplate>
