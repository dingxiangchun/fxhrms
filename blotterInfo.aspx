<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blotterInfo.aspx.cs" Inherits="blotterInfo" %>
                                                ...
                                                <TR>
                                                    ...
                                                    <TD>
                                                        <asp:DropDownList ID="ddl1" runat="server"  AutoPostBack="True">
                                                            ...
                                                            <asp:ListItem Value="2">按类别查询</asp:ListItem>
                                                            <asp:ListItem Value="3">按标题查询</asp:ListItem>
                                                        </asp:DropDownList>
                                                ...
                                                <asp:TemplateField HeaderText="日期">
                                                    <ItemTemplate>
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label runat="server" ID="Label1" Text='<%# Eval("noteDate") %>'></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="类型">
                                                    <ItemTemplate>
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label runat="server" ID="Label2" Text='<%# Eval("noteSort") %>'></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="标题">
                                                    <ItemTemplate>
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label runat="server" ID="Label3" Text='<%# Eval("tTitle") %>'></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="详细">
                                                    <ItemTemplate>
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td>
 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "blotter.aspx?id="+Eval("id").ToString() %>'>查看</asp:HyperLink>                                                   
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
